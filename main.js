...
const listaInformacion = ["AMD", "INTEL", "memoria 4gb","memoria 8gb","disco solido", "disco duro"]

let lista = prompt("ingrese el nombre del producto a consultar(´f´ para ir directo a comprar)");
while(lista != "f"){
    if (listaInformacion.includes(lista)){
        alert("el producto se encuentra disponible")
    }else{
        alert("no esta disponible");
    }
    lista = prompt("ingrese el nombre del producto a consultar(´f´ para ir directo a comprar)");
}
